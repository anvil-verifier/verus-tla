// A two-thread mutex liveness proof.
//
// Model: two threads compete for a lock. Each thread goes through
// Waiting → Holding → Terminated. Under weak fairness of both
// acquire and release actions, both threads eventually terminate.
//
// This demonstrates `wf1`, `leads_to_trans_n!`, `or_leads_to`, and
// `leads_to_apply`.
#![allow(unused_imports)]
use verus_temporal_logic::action::*;
